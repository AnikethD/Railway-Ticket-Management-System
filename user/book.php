...
if(isset($_POST['submit']))
{
	...
	//$train_no=test_input($_POST['amt']);
} 

//$random1=str_shuffle("012345678915975369740582198745632109632587410756489156324");
...
?>
			...
			function validate_from()
			{
				...
				// x=document.forms["adform"]["amt"].value;
				//if(x==null || x=="")
				//{
				//	return false;
				//}
		...
		<script>
// function myFunction() {
  //document.getElementById("demo").innerHTML = <?php //echo $amt;?>;
//}
</script>
			  ...
			  <div class="col-md-12 forminput">
				<form style="margin-top:25px;" name="adform" action="tickets.php" onsubmit="return validate_from()" method="post" class="form-horizontal" >
				  ...
				  <div class="form-group">
					...
					<div class="form-group">
					<label  class="col-sm-3 control-label" for="sel1">Select Payment Mode</label>
					<div class="col-sm-8" > 
					<select class="form-control forminp selectform " name="mode" id="msel1"><option value="credit card">Credit Card</option>
                       <option value="debit card" id="dc" >Debit Card</option><option value="nb">Net Banking</option><option value="upi">UPI</option></select>
					</div> 
					</div>
					<!-- <div class="form-group"> 
					<div class="form-group">
					<label  class="col-sm-3 control-label" for="sel1">Amount</label>
					<div class="col-sm-8">
					<h5 id="demo" name="amt" ></h5>
					</div>
				  </div>
				  </div> -->
					<!-- <div class="col-sm-8" > -->
					<!-- <label  class="col-sm-3 control-label" for="sel1" id="demo" onclick="myFunction()"> Price <p >Click me.</p> </label> </div> -->
...
// $_SESSION['TrainNumber'] = $_POST['TrainNumber'];
// include('../footer.php'); ?>
